<template>
  <div class="upload-box" @click="btnClick">
    <el-upload
      :data='option.data'
      :id='option.propId'
      :ref='option.propId'
      ...
      :file-list='fileList'>
      <el-button v-if="option.listType !== 'picture-card'" size="small" type="primary">{{$t('vicenter.common.uploadText')}}</el-button>
...
export default {
  ...
  methods: {
    btnClick () {
      this.propOption.specialcharaPrompt = false
    },
    handleSubmit () {
