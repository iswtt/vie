          ...
          <div class="up-down-panel">
            ...
            <div class="image-info-box">
              ...
              <div class="border physicalBox">
                ...
                <detailList :listData="resultInfo.physicalResult" :widthStyle="allWidth"></detailList>
...
export default {
  ...
  data () {
    return {
      ...
      panelTitle: { // title组件数据
        queryTitle: {
          title: this.$t('vicenter.inspection.common.HistoryDetailForm')
        }
      },
      title: {
  ...
  methods: {
    ...
    getBack () {
      this.$router.push({ path: '/Inspection/History' })
    },
    LookImg () {
