     ...
     <div class="background-device-M">
        ...
        <div class="infolist">
          ...
          <div class="panel panel-L">
            <panelTitle :panelTitleInit="panelTitle.listTitle">
              ...
              <el-button type="primary" size="mini" @click="getAdd">{{$t('vicenter.common.add')}}</el-button>
            </panelTitle>
        ...
        <div class="modal-dialog">
          ...
          <Dialog :modalData="detailData">
            ...
            <div class="resultbutton">
              <el-button @click="closeDetailModal" size="mini">{{$t('vicenter.common.close')}}</el-button>
            </div>
          </Dialog>
          <DialogCommon :modalData="mapData">
            <div class="deviceMapContainer">
              <ul class="coorShow">
                <li>{{$t('vicenter.Background.device.longitude')}}: <span>{{tempDeviceCoord.lng}}</span></li>
                <li>{{$t('vicenter.Background.device.latitude')}}: <span>{{tempDeviceCoord.lat}}</span></li>
              </ul>
            ...
            <div class="deviceMapButton">
              <el-button :disabled="isSaving" @click="saveDeviceCoord" type="primary" size="mini" >{{$t('vicenter.common.sure')}}</el-button>
              <el-button @click="resetMapModal" size="mini">{{$t('vicenter.common.cancel')}}</el-button>
            </div>
          </DialogCommon>
        </div>
     </div>
      ...
      modalRule: { // 弹窗表单验证和存放数据 model=> post到后台的数据
        ...
        rule: {
          deviceCode: [ // 设备编号校验
            ...
            { pattern: /^[a-zA-Z0-9_]+$/, message: this.$t('vicenter.common.verifyRules.onlyLDU'), trigger: ['blur', 'change'] }
          ],
          deviceName: [ // 设备名称校验
