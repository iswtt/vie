<template>
  <div class="upload-box">
    <el-upload
      ...
      :file-list='fileList'>
      <el-button type="primary" size="mini" @click="btnClick">{{$t('vicenter.ImageLibrary.common.Upload')}}</el-button>
...
export default {
  ...
  methods: {
    btnClick () {
      this.propOption.overLimitPrompt = false
    },
    handleSubmit () {
