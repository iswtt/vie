  ...
  methods: {
    routeChange () {
      switch (this.$route.path) {
        ...
        case '/Reports/personnel-manual-trend': {
        ...
        case '/Reports/personnel-audit-trend': {
        ...
        for (let i in this.dimensionSearchObj) {
          if (this.searchIpt[0].models === i) {
            if (item.ruleProp === this.dimensionSearchObj[i].show) {
              ...
              this.formRule.model[item.ruleProp] = item.option[0].value
            }
