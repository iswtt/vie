...
export default {
  ...
  data () {
    return {
      ...
      printTable: {
        allColsNum: 5,
        title: this.$t('vicenter.reports.title.personnelEfficiencyDetail'),
  ...
  methods: {
    ...
    query () {
      ...
      if (params.type === 'AUDITOR') {
        ...
        this.printTable.infoData[3].colspan = 5
        if (this.printTable.infoData[1].data.length === 4) {
          ...
          this.printTable.infoData[1].data.splice(4, 1, obj)
          this.printTable.infoData[2].data.splice(4, 1, obj)
        }
      }
      this.printTable.infoData[1].data[1].value = this.searchObj[params.type].personInfo
      ...
      this.printTable.infoData[2].data[0].value = this.searchObj[params.type].personInfo
