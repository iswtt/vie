...
export default {
  ...
  data () {
    return {
      ...
      printTable: {
        allColsNum: 8,
        title: this.$t('vicenter.reports.title.personnelComparedDetail'),
  ...
  methods: {
    ...
    queryCompare () {
      ...
      this.printTable.infoData[2].data[1].value = this.dimensionSearchObj[paramsCompare.type].dimensionInfo
      this.printTable.infoData[2].data[2].value = this.dimensionSearchObj[paramsCompare.type].dimensionInfo
      this.printTable.infoData[2].data[3].value = paramsCompare.accountStr
