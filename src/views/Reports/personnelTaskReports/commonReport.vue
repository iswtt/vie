  ...
  data () {
    return {
      ...
      tableGroup: [
        ...
        {
          label: this.$t('vicenter.reports.common.consistentQty'),
          type: 'text',
          model: 'consistentNum',
          width: ''
        },
        {
          label: this.$t('vicenter.reports.common.inconsistentQty'),
          type: 'text',
  ...
  methods: {
    routeChange () {
      switch (this.$route.path) {
        case '/Reports/personnel-analysis-task': {
          this.printTable.allColsNum = 7
          this.printTable.infoData[0].colspan = 7
          this.printTable.infoData[1].data[3].colspan = 4
          this.printTable.infoData[2].colspan = 7
          this.searchIpt[0].models = 'INSPECTOR'
          this.searchIpt[0].defaultValue = 'INSPECTOR'
          this.formRule.model.type = 'INSPECTOR'
          this.tableGroup.splice(5, 2)
          break
        }
        case '/Reports/personnel-recheck-task': {
          this.printTable.allColsNum = 9
          this.printTable.infoData[0].colspan = 9
          this.printTable.infoData[1].data[3].colspan = 6
          this.printTable.infoData[2].colspan = 9
        ...
        case '/Reports/personnel-manual-task': {
          this.printTable.allColsNum = 7
          this.printTable.infoData[0].colspan = 7
          this.printTable.infoData[1].data[3].colspan = 4
          this.printTable.infoData[2].colspan = 7
        ...
        case '/Reports/personnel-audit-task': {
          this.printTable.allColsNum = 7
          this.printTable.infoData[0].colspan = 7
          this.printTable.infoData[1].data[3].colspan = 4
          this.printTable.infoData[2].colspan = 7
    ...
    query () {
      ...
      this.printTable.infoData[1].data[2].value = this.searchObj[params.type].chartTitle
      ...
      if (params.type === 'RECHECK-INSPECTOR') {
        // 获取复审结论一致量、结论不一致量
        ajax.getConcSameQtyData(params).then((res) => {
          if (res.data.flag) {
            consistentNum = {
              'type': 'consistentNum',
              'items': res.data.result.items
        ...
        ajax.getConcNotSameQtyData(params).then((res) => {
          if (res.data.flag) {
            inconsistentNum = {
              'type': 'inconsistentNum',
              'items': res.data.result.items
