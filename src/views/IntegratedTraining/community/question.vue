    ...
    <div class="out">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item :label="$t('vicenter.IntegratedTraining.community.attachUpload')" prop="upload">
          <el-upload class="upload-question" action="https://jsonplaceholder.typicode.com/posts/" :file-list="fileList" :on-preview="handlePreview" :on-remove="handleRemove" :before-remove="beforeRemove" multiple :limit="1" :on-exceed="handleExceed" >
